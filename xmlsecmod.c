...
static PyMethodDef xmlsec_methods[] = {
  ...
  {"cryptoAppKeysMngrCertLoadMemory",  xmlsec_CryptoAppKeysMngrCertLoadMemory,  METH_VARARGS},
  {"cryptoAppKeyLoad",                 xmlsec_CryptoAppKeyLoad,                 METH_VARARGS},
  {"cryptoAppKeyLoadMemory",           xmlsec_CryptoAppKeyLoadMemory,           METH_VARARGS},
  {"cryptoAppPkcs12Load",              xmlsec_CryptoAppPkcs12Load,              METH_VARARGS},
  {"cryptoAppKeyCertLoad",             xmlsec_CryptoAppKeyCertLoad,             METH_VARARGS},
  {"cryptoAppKeyCertLoadMemory",       xmlsec_CryptoAppKeyCertLoadMemory,       METH_VARARGS},
